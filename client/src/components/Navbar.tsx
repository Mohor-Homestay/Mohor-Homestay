...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: '/gallery', name: 'Gallery', icon: <Image className="w-5 h-5" /> },
    { path: '/rate-tariff', name: 'Rate Tariff', icon: <IndianRupee className="w-5 h-5" /> },
    { path: '/contact', name: 'Contact Us', icon: <Phone className="w-5 h-5" /> },
  ];
